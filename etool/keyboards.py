...
def category_menu(back="general_menu"):
    keyboard = VkKeyboard(one_time=True)
    keyboard.add_button('Питание', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "spending", "inc": "FOOD"})
    keyboard.add_button('Одежда', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "spending", "inc": "DRESS"})
    keyboard.add_button('Для дома', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "spending", "inc": "FOR_HOME"})

    keyboard.add_line()
    keyboard.add_button('Авто', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "spending", "inc": "AUTO"})
    keyboard.add_button('Транспорт', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "spending", "inc": "TRANSPORT"})
    keyboard.add_button('ЖКХ/Связь', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "spending", "inc": "H_SERVICE"})

    keyboard.add_line()
    keyboard.add_button('Досуг', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "spending", "inc": "ENTERTAIMENT"})
    keyboard.add_button('Подарки', color=VkKeyboardColor.DEFAULT,
    ...
    keyboard.add_line()
    keyboard.add_button('Кредиты', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "spending", "inc": "CREDIT"})
    keyboard.add_button('Копилка', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "spending", "inc": "ACCUM"})
    keyboard.add_button('Другое', color=VkKeyboardColor.DEFAULT,
...
def history_menu(back="general_menu"):
    keyboard = VkKeyboard(one_time=True)
    keyboard.add_button('Посл. 20', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "history", "inc": "h_last_20"})
    keyboard.add_button('Неделя', color=VkKeyboardColor.DEFAULT,
                        payload={"action": "history", "inc": "h_week"})
    keyboard.add_button('Месяц', color=VkKeyboardColor.DEFAULT,
...
def statistics_menu(back="general_menu"):
    keyboard = VkKeyboard(one_time=True)
    keyboard.add_button('Общая', color=VkKeyboardColor.DEFAULT,
