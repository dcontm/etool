...
class Round():
    ...
    def get_period(self):
        ...
        if self.period == 's_week':
            ...
            self.message = ("Диаграмма деления платежей по категориям"
                            "за прошедшую неделю "
                            "с {} по {}").format(start_period.format('DD.MM'),
                                                 end_period.format('DD.MM'))
            ...
            по категориям за {}".format(prev_month.format('MMMM'))
            ...
            if self.query:
                ...
                end_period = date
                self.message = "Диаграмма деления платежей по категориям \
                начиная с {}.".format(start_period.format("DD.MM.YYYY"))
            else:
                self.status = False
        ...
        if self.query:
            self.title = ("Круговая диаграмма платежей по категориям \n"
                          "за период c {} по {}").format(start_period.format('DD.MM'),
                                                         end_period.format('DD.MM'))
    ...
    def run(self):
        ...
        if data:
            ...
            filename = ('/home/dcoxtm/project/media/grafics/'
                        'round-{}-{}').format(self.period,
                                              uuid.uuid4())
            ...
            self.message = ("Ваш первый платеж произошел,"
...
class Wall():
    ...
    def get_period(self):
        ...
        if self.period == 's_week':
            ...
            self.message = ("Диаграмма величины платежей "
                            "за прошедшую неделю "
                            "с {} по {}").format(start_period.format('DD.MM'),
                                                 end_period.format('DD.MM'))
            ...
            if self.query:
                ...
                self.message = ("Диаграмма величины платежей начиная с {}\n "
                                ...
                                " давности.").format(start_period.format("DD.MM.YYYY"))
            else:
                self.status = False
    ...
    def run(self):
        ...
        if data:
            ...
            filename = ('/home/dcoxtm/project/media/'
                        'grafics/wall-{}-{}').format(self.period,
                                                     uuid.uuid4())
